                    ...
                    <div className="col-lg-5 ">
                      <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                          ...
                          <li className="breadcrumb-item"><NavLink to="/foodgrain" activeClassName="active">FoodGrains & Oil</NavLink></li>
                                ...
                                <div className="front">
                                  <div className="card-body">
                                    <div className="d text-center mt-5 mb-4">
                                      <Link to={`FoodGrainDetail/${a.id}`}><span className="quick">Quick View</span></Link></div>
